...
var Drivers=[]EthercatDriver{
  ...
  EthercatDriver{
    ...
    ModParams: []string{
      ...
      "<modParam name=\"sdoReadConfig\" value=\"Bitmask enabling Infos-RO acyclic SDO monitoring channels. Bit 0=power-kw (0x264A) | Bit 1=motor-current (0x264E) | Bit 2=dc-link-voltage (0x265E) | Bit 3=motor-thermal-pct (0x2652) | Bit 4=kty-temperature (0x2653) | Bit 5=heatsink-temp (0x2662) | Bit 6=inverter-thermal-pct (0x2663) | Bit 7=ctrl-card-temp (0x2667) | Bit 8=torque-nm (0x2650) | Bit 9=kwh-counter (0x25DE) | Bit 10=torque-pct (0x2656). 0=disable all (default). 0x7FF=enable all 11 channels. Only enabled channels get HAL pins and are polled. The Infos-RO.sdo-busy pin is only created if at least one bit is set.\"/> ",
      "",
    },
  },
  EthercatDriver{
