...
static const lcec_pindesc_t slave_pins[] = {
    ...
    {HAL_FLOAT, HAL_IO,  offsetof(lcec_ep5101_data_t, pos_scale),
                "%s.%s.%s.enc-pos-scale"},
    {HAL_BIT,   HAL_IN,  offsetof(lcec_ep5101_data_t, ena_latch_c),
                "%s.%s.%s.enc-ena-latch-c"},
    {HAL_BIT,   HAL_IN,  offsetof(lcec_ep5101_data_t, ena_latch_ext_pos),
                "%s.%s.%s.enc-ena-latch-ext-pos"},
    {HAL_BIT,   HAL_IO,  offsetof(lcec_ep5101_data_t, set_counter),
                "%s.%s.%s.enc-set-counter"},
    {HAL_BIT,   HAL_IN,  offsetof(lcec_ep5101_data_t, ena_latch_ext_neg),
